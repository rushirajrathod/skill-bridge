...
The project was designed with responsible AI practices in mind.
	1.	AI recommendations are treated as guidance, not guaranteed answers
	2.	The interface includes AI disclaimers so users understand that results may not always be perfect
	3.	The system does not make automated hiring decisions
	4.	No sensitive personal data is stored
